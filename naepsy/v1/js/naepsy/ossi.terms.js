...
* ossi terms class
*/
ossi.terms = Class.create(ossi.base,{
  ...
  _draw: function() {
    if (this.options.hostElement) {
      ...
      alert('ossi.terms._draw() failed! this.options.hostElement not defined!');
    }
  },
  _getHTML: function() {
    var h =   '\
                    ...
                    <h2>Terms of Use</h2>\
                    <p>Ossi is a social media service that allows its users to inter-communicate. It is a part of Helsinki University of Technology’s (HUT) OtaSizzle-research project, where the service is being tested and developed. The project is conducted by Helsinki Institute for Information Technology (HIIT), a joint research institute of HUT and University of Helsinki. The Ossi-service may only be used in accordance with these terms of use. HIIT reserves the right to change these terms of use if required. Valid terms of use can be found from Ossi’s website. \
                    ...
                    <h3>Disclaimer</h3>\
                    <p>Ossi-service is experimental in its nature, as well as a part of a study and therefore no guarantees of its functioning can be given. HIIT, HUT and University of Helsinki can under no circumstances be liable for damage that is caused to the user. The user may not store any information or data in the service, and expect it to remain there. \
                    <h3>The Removal of a User</h3>\
                    <p>HIIT has the right to remove any users from Ossi and terminate their right of use of the service without any specific reason and without being liable for compensation.\
