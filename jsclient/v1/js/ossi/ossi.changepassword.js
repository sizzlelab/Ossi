...
ossi.changepassword = Class.create(ossi.base,{
  ...
  _saveHandler: function() {
    ...
    if (p != pc) {
      self.parent.case6({
	  	backCase: self.parent.case29.bind( self.parent, {
		  out: true,
...
*/
  ...
  _removeListeners: function() {
    $('password_save_button').onclick = function() { return }
    $('password_cancel_button').onclick = function() { return }
  },
  destroy: function () {
